...
const ExperienceEntry = ({ id, year, title, duration, imageSrc, expanded, toggleExpand, visible, children }) => (
  <div 
    id={id} 
  ...
  > 
    ...
    <div className="w-1/3 flex items-center justify-end pr-6">
      {imageSrc && (
        <Image
          ...
          width={120} 
          height={120}
          className="rounded-lg shadow-md mr-6" // Added margin-right for spacing
        />
      )}
    ...
    {/* Experience Details - Aligned Right with Proper Spacing */}
